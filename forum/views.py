...
# Finalizar pagamento e cadastro de endereço (checkout)
def checkout(request):
    ...
    if request.method == 'POST' and 'forma_pagamento' in request.POST:
        # Agora sim é a confirmação FINAL
        request.session['carrinho'] = {}  # Limpa o carrinho
        messages.success(request, 'Compra finalizada com sucesso!')
        return render(request, 'forum/obrigado.html')  # <-- Muda aqui!

    # Se for GET, ou POST sem 'forma_pagamento' (ainda não confirmou), mostra o formulário
